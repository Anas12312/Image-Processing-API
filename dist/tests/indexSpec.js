...
describe('Test endpoint responses', function () {
    ...
    it('Expect to Send the resized File', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
    ...
    it("Expect to Send File Doesn't Exist", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/images?' + 'filename=noFile&width=200&height=200')];
                case 1:
                    response = _a.sent();
    ...
    it('Expect to Send Not Enough Parameters', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
describe('Test the Clone Image', function () {
    // Test if the Function is Working
    it('Expect to Return True', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, cloneImage_1.default)('palmtunnel', '200', '200')];
                case 1:
                    result = _a.sent();
    ...
    it('Expect to Return False', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, cloneImage_1.default)('noFile', '200', '200')];
                case 1:
                    result = _a.sent();
